...
class foundingbody
{
    ...
    //Get Ownership Name
    public static function getFoundingBodyName($id){
        $sql = database::performQuery("SELECT name FROM founding_body WHERE id=$id");
        $ret = $sql->fetch_assoc();
        return $ret['name'];
    }
    ...
    public static function prepMapSwitch(){
        ...
        $districts = self::activeDistrict($_SESSION['founding_body_active']);
    ...
    public static function viewSchool() {
        $name = ucwords(strtolower(self::getFoundingBodyName($_REQUEST['id'])));
        //Check If District Exists
        $sql = database::performQuery("SELECT * FROM founding_body WHERE name LIKE '%$name%'");
        if($sql->num_rows == 0)
            notFound();
        else
        {
            ...
            $_SESSION['founding_body_active'] = $founding_body['id'];
                                                ...
                                                <div>
                                                    ...
                                                    <div class="portlet light ">
                                                        <div class="portlet-title">
                                                            <div class="caption">
                                                                <span class="caption-subject font-green bold uppercase">'.ucwords(strtolower($name)).' Schools in Uganda  </span>
                                                            </div>
    
                                                        </div>
                                                        <div class="portlet-body">
                                                             <p>'.ucwords(strtolower($name)).' Schools in Uganda are schools founded by the '.$name.'.
                                                              There are over '.number_format(self::countSchoolsWithTypeId($founding_body['id'])).'+ '.$name.' schools in Uganda on
                                                               school guide and we bring you all of them here in over
                                                        '.self::countDistrictSchoolsWithOwnershipID($founding_body['id']).' Districts in Uganda. 
                                                       </p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="portlet light ">
                                                        ...
                                                        <div class="portlet-body">
                                                            ...
                                                            <table class="table table-striped table-bordered table-advance table-hover">
                                                                ...
                                                                <tbody>';
            $content .=  self::viewDistrictSchoolsCategory($founding_body);
            $content .=  self::viewDistrictTotalSchool($founding_body);
            $content .=' </tbody>
                                                            </table>
                                                        </div>
                                                    ...
                                                    <div class="portlet light ">
                                                        ...
                                                        <div class="portlet-body">
                                                            ...
                                                            <table class="table table-striped table-bordered table-advance table-hover">
                                                                ...
                                                                <tbody>';
            $content .=  self::viewDistrictGender($founding_body);
            $content .=  self::viewDistrictOwnership($founding_body);
            $content .=' </tbody>
                                                            </table>
                                                        </div>
                                                            ...
                                                            <table class="table table-striped table-bordered table-advance table-hover">
                                                                ...
                                                                <tbody>';
            $content .= self::viewDistrictBoarding($founding_body);
            $content .=' </tbody>
                                                            </table>
                                                        </div>
                                                    ...
                                                    <div class="portlet light ">
                                                        ...
                                                        <div class="portlet-body">   
															...
															<div class="row">
                                                                ...
                                                                '.self::prepAlldistricts($founding_body['id']).'
                                                    ...
                                                    <div class="portlet light ">
                                                        ...
                                                        <div class="portlet-body">   
															...
															<div class="row">
                                                                ...
                                                                '.self::viewGenderByLetter($founding_body['id'],ucwords(strtolower($name))).'
    ...
    public static function viewGenderByLetter($gender,$name){
        ...
        foreach (letters() as $letter)
        {
            if(self::schoolsByLetter($gender,$letter) == 0)
                ...
                $content .='<a href="'.ROOT.'/?founding_body='.$gender.'&letter='.$letter.'&action=search"><button class="btn yellow-gold btn-xs tooltips" data-container="body" data-placement="top" data-original-title="'.self::schoolsByLetter($gender,$letter).' '.$name.'  Schools">'.$letter.'</button> </a>&nbsp;';
        }
