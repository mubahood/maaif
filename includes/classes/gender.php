...
class gender
{
    ...
    public static function getGenderName($id){
        $sql = database::performQuery("SELECT name FROM school_type WHERE name LIKE '%$id%'");
        $ret = $sql->fetch_assoc();
        return $ret['name'];
    }
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                <div class="portlet light portlet-fit ">
                                                    <div class="portlet-body">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="mt-overlay-3">
                                                                        ...
                                                                        <div class="mt-overlay">
                                                                            <h2>BOYS ONLY SCHOOLS</h2>
                                                                            <a class="mt-info" href="'.ROOT.'/find-a-market/gender/boys">Broswe over '.number_format(self::countSchoolsWithTypeId(1)).'+ boys schools in Uganda on school guide.</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <p>&nbsp;</p>
                                                        <p>Boys Schools in Uganda are schools exclusively for boys. There are over '.number_format(self::countSchoolsWithTypeId(1)).'+ boys schools in Uganda on school guide and we bring you all of them here in over
                                                        '.self::countDistrictSchoolsWithTypeId(1).' Districts. Browse boys schools in Uganda <a href="'.ROOT.'/find-a-market/gender/boys"><button class="btn btn-xs green">Here</button></a></p>
                                                           </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="portlet light portlet-fit ">
                                                    <div class="portlet-body">
                                                        <div class="mt-element-overlay">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="mt-overlay-3">
                                                                        ...
                                                                        <div class="mt-overlay">
                                                                            <h2>GIRLS ONLY SCHOOLS</h2>
                                                                            <a class="mt-info" href="'.ROOT.'/find-a-market/gender/girls">Broswe over '.number_format(self::countSchoolsWithTypeId(2)).'+ girls schools in Uganda on school guide.</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                         ...
                                                         <p>&nbsp;</p>
                                                        <p>Girls Schools in Uganda are schools exclusively for girls. 
                                                        There are over '.number_format(self::countSchoolsWithTypeId(2)).'+ girls schools in Uganda on school
                                                         guide and we bring you all of them here in over
                                                        '.self::countDistrictSchoolsWithTypeId(2).' Districts. Browse girls schools in
                                                        Uganda <a href="'.ROOT.'/find-a-market/gender/girls"><button class="btn btn-xs green">Here</button></a></p>
                                                ...
                                                <div class="portlet light portlet-fit ">
                                                    <div class="portlet-body">
                                                        <div class="mt-element-overlay">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="mt-overlay-3">
                                                                        ...
                                                                        <div class="mt-overlay">
                                                                            <h2>MIXED SCHOOLS</h2>
                                                                            <a class="mt-info" href="'.ROOT.'/find-a-market/gender/mixed">Broswe over '.number_format(self::countSchoolsWithTypeId(3)).'+ mixed schools in Uganda on school guide.</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                         ...
                                                         <p>&nbsp;</p>
                                                        <p>Mixed/Co-Ed Schools in Uganda are schools  for both boys and  girls. 
                                                        There are over '.number_format(self::countSchoolsWithTypeId(3)).'+ mixed schools in Uganda on school
                                                         guide and we bring you all of them here in over
                                                        '.self::countDistrictSchoolsWithTypeId(3).' Districts. Browse mixed schools in
                                                        Uganda <a href="'.ROOT.'/find-a-market/gender/mixed"><button class="btn btn-xs green">Here</button></a></p>
    ...
    public static function viewSchool() {
        $name = ucwords(strtolower($_REQUEST['gender']));
        //Check If District Exists
        $sql = database::performQuery("SELECT * FROM school_type WHERE name LIKE '%$name%'");
        if($sql->num_rows == 0)
            notFound();
        else
        {
            ...
            $_SESSION['gender_active'] = $gender['id'];
                                                ...
                                                <div>
                                                    ...
                                                    <div class="portlet light ">
                                                        <div class="portlet-title">
                                                            <div class="caption">
                                                                <span class="caption-subject font-green bold uppercase">'.ucwords(strtolower($gender['name'])).' Schools in Uganda  </span>
                                                            </div>
    
                                                        </div>
                                                        <div class="portlet-body">
                                                             <p>'.ucwords(strtolower($gender['name'])).' Schools in Uganda are schools exclusively for '.$name.'.
                                                              There are over '.number_format(self::countSchoolsWithTypeId($gender['id'])).'+ '.$name.' schools in Uganda on
                                                               school guide and we bring you all of them here in over
                                                        '.self::countDistrictSchoolsWithTypeId($gender['id']).' Districts. 
                                                       </p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="portlet light ">
                                                        ...
                                                        <div class="portlet-body">
                                                            ...
                                                            <table class="table table-striped table-bordered table-advance table-hover">
                                                                ...
                                                                <tbody>';
            $content .=  self::viewDistrictSchoolsCategory($gender);
            $content .=  self::viewDistrictTotalSchool($gender);
            $content .=' </tbody>
                                                            </table>
                                                        </div>
                                                    ...
                                                    <div class="portlet light ">
                                                        ...
                                                        <div class="portlet-body">
                                                            ...
                                                            <table class="table table-striped table-bordered table-advance table-hover">
                                                                ...
                                                                <tbody>';
            $content .=  self::viewDistrictOwnership($gender);
            $content .= self::viewDistrictBoarding($gender);
            $content .=' </tbody>
                                                            </table>
                                                        </div>
                                                            ...
                                                            <table class="table table-striped table-bordered table-advance table-hover">
                                                                ...
                                                                <tbody>';
            $content .=  self::viewDistrictFoundingBody($gender);
            $content .=' </tbody>
                                                            </table>
                                                        </div>
                                                    ...
                                                    <div class="portlet light ">
                                                        ...
                                                        <div class="portlet-body">   
															...
															<div class="row">
                                                                ...
                                                                '.self::prepAlldistricts($gender['id']).'
                                                    ...
                                                    <div class="portlet light ">
                                                        ...
                                                        <div class="portlet-body">   
															...
															<div class="row">
                                                                ...
                                                                '.self::viewGenderByLetter($gender['id'],ucwords(strtolower($gender['name']))).'
    ...
    private static function viewDistrictSchoolsCategory($gender){
        ...
        while ($data = $sql->fetch_assoc())
        {
            ...
            $content .='<tr>
                               <td class="highlight"> <div class="'.$colors[rand(0,3)].'"></div> &nbsp; <b> '.ucwords(strtolower($data['name'])).' Schools</b> </td>
                                <td> '.$data['schools'].'</td>
                                <td>
                                  <a href="'.ROOT.'/?category='.$data['id'].'&gender='.$gender['id'].'&action=search">  <span class="label label-sm label-success"> View List</span></a>
                                </td>
                            </tr>';
            ...
            if($sqlc->num_rows > 0){
                while ($datac = $sqlc->fetch_assoc())
                {
                    ...
                    $content .='<tr>
                                ...
                                <td> '.$datac['schools'].'</td>
                                <td>
                                <a href="'.ROOT.'/?category='.$datac['id'].'&gender='.$gender['id'].'&action=search">  <span class="label label-sm label-success"> View List</span></a>
    ...
    private static function viewDistrictFoundingBody($gender)
    {
        ...
        while($data = $sql->fetch_assoc()){
            $content .='<tr>
                                ...
                                <td> '.$data['schools'].'</td>
                                <td>
                                  <a href="'.ROOT.'/?gender='.$gender['id'].'&founding_body='.$data['id'].'&action=search">  <span class="label label-sm label-success"> View List</span></a>
                                </td>
                            </tr>';
        }
    ...
    private static function viewDistrictOwnership($gender)
    {
        ...
        while($data = $sql->fetch_assoc()){
            $content .='<tr>
                                ...
                                <td> '.$data['schools'].'</td>
                                <td>
                                  <a href="'.ROOT.'/?gender='.$gender['id'].'&ownership='.$data['id'].'&action=search">  <span class="label label-sm label-success"> View List</span></a>
                                </td>
                            </tr>';
        }
    ...
    private static function viewDistrictBoarding($gender)
    {
        ...
        while($data = $sql->fetch_assoc()){
            $content .='<tr>
                                ...
                                <td> '.$data['schools'].'</td>
                                <td>
                                  <a href="'.ROOT.'/?gender='.$gender['id'].'&boarding='.$data['id'].'&action=search">  <span class="label label-sm label-success"> View List</span></a>
                                </td>
                            </tr>';
        }
    ...
    public static  function viewAllDistrictsInfo($id)
    {
        ...
        $content .='<div class="table-scrollable table-scrollable-borderless"> <table class="table table-hover table-light"><tr>';
        while ($row = $result->fetch_assoc()){
            $content .='<td><small> <i class="icon-check" style="color:#3598DC"></i> <a href="'.ROOT.'/?gender='.$id.'&district='.$row['id'].'&action=search">' . ucwords(strtolower($row['name'])) . ' District</a> ('.$row['schools'].') </small></td>';
            if ($i == 4) {
                $content .= '</tr><tr>';
                $i = 0;
            }
    ...
    public static function viewGenderByLetter($gender,$name){
        ...
        foreach (letters() as $letter)
        {
            if(self::schoolsByLetter($gender,$letter) == 0)
                ...
                $content .='<a href="'.ROOT.'/?gender='.$gender.'&letter='.$letter.'&action=search"><button class="btn yellow-gold btn-xs tooltips" data-container="body" data-placement="top" data-original-title="'.self::schoolsByLetter($gender,$letter).' '.$name.'  Schools">'.$letter.'</button> </a>&nbsp;';
        }
