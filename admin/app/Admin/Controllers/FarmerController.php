...
class FarmerController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $grid->column('education_level_id', __('Education level id'));
        $grid->column('main_language', __('Main language'));
        $grid->column('secondary_language', __('Secondary language'));
    ...
    protected function detail($id)
    {
        ...
        $show->field('education_level_id', __('Education level id'));
        $show->field('main_language', __('Main language'));
        $show->field('secondary_language', __('Secondary language'));
    ...
    protected function form()
    {
        ...
        $form->number('education_level_id', __('Education level id'));
        $form->number('main_language', __('Main language'));
        $form->number('secondary_language', __('Secondary language'));
